...
public class CadastroCarroBean implements Serializable{
	...
	public CadastroCarroService getCadastroCarroService() {
		return cadastroCarroService;
	}

	public void setCadastroCarroService(CadastroCarroService cadastroCarroService) {
	...
	public void setAcessorioDAO(AcessorioDAO acessorioDAO) {
